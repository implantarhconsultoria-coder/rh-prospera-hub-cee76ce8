...
import { Clock, ClipboardList, Package, Gauge, LogIn, UtensilsCrossed, Coffee, LogOut as LogOutIcon, Car, Fuel, Droplet, History } from 'lucide-react';
...
const opActions = [
  ...
  { label: 'Abastecimento (QR)', sub: 'Posto · QR + foto da bomba', icon: Fuel, sub2: 'abastecimento', gradient: 'from-orange-500 to-red-600' },
  { label: 'Combustível Galões', sub: 'Retirada interna do galão', icon: Droplet, sub2: 'galoes', gradient: 'from-yellow-500 to-amber-700' },
